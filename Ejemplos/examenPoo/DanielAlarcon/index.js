...
let gestorAlumnos = new GestorAlumnos(alumnos)
const alumno = new Alumno('Dani', 'Alarcón Muñoz', '2006-09-11', 'daniel.alarcon.7e6@itb.cat', 'DAWe', [10, 10, 9, 10])

function init() {
    //LISTAR ALUMNOS
    console.log('*****Lista de alumnos al principio:*****')
    console.log(gestorAlumnos.listarAlumnos())

    //BUSCAR ALUMNO POR NOMBRE
    console.log(gestorAlumnos.buscarAlumno('Ana Pérez Gómez'))

    //AGREGAR NUEVO ALUMNO
    console.log('*****Se ha agregado un nuevo alumno:*****')
    gestorAlumnos.agregarAlumno(alumno)
    console.log(gestorAlumnos.listarAlumnos())

    //ELIMINAR ALUMNO
    console.log(gestorAlumnos.eliminarAlumno('Ana Pérez Gómez'))
    console.log(gestorAlumnos.listarAlumnos())
    console.log(gestorAlumnos.buscarAlumno('Ana Pérez Gómez'))

    //MOSTRAR ALUMNOS ORDENADOS ALFABETICAMENTE
